...
void callback_bt0(t_but *but){
	but->status = !but->status;
	draw_button_new(*but);
}

void callback_bt1(t_but *but){
	but->status = !but->status;
	draw_button_new(*but);
}

void callback_bt2(t_but *but){
	but->status = !but->status;
	draw_button_new(*but);
}
...
void task_lcd(void){
	...
	t_but but0 = {.width = 120, .height = 75, .border = 2,
		.colorOn = COLOR_SILVER, .colorOff = COLOR_BLACK,
	.x = ILI9488_LCD_WIDTH/2, .y = 40, .status = 1, .callback = &callback_bt0 };
	
	t_but but1 = {.width = 120, .height = 75, .border = 2,
		.colorOn = COLOR_GOLD, .colorOff = COLOR_BLACK,
	.x = ILI9488_LCD_WIDTH/2, .y = 140, .status = 1, .callback = &callback_bt1 };
	
	t_but but2 = {.width = 120, .height = 75, .border = 2,
		.colorOn = COLOR_NAVY, .colorOff = COLOR_BLACK,
	.x = ILI9488_LCD_WIDTH/2, .y = 240, .status = 1, .callback = &callback_bt2 };
